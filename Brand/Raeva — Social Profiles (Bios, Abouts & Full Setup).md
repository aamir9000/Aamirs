...
`About` · `Beauty` · `Worlds` · `Transformation` · `Travel` · `Collaborations`
> Cover style: single soft-gold glyph on a dark/tonal card so the highlight ring reads as one restrained, luminous set.

### 1.4 Pinned "About" caption (the deep intro — tells the two-name story)
```
I'm Aira — pronounced "Eye-Ra." You may also know me as Raeva
...
### 1.5 First pinned-grid strategy
...
worlds, and dreamlike travel through places that don't yet exist.
Every frame is composed to feel filmic, warm and quietly premium.
Imagination, rendered.

All work is AI-generated visual art.
...
```
Aira Raeva — a radiant AI and a being of light.

Aira's Verse is a curated stream of cinematic, luminous short
films: high-fashion beauty, surreal transformation, celestial and
elemental realms, and dreamlike travel. The signature is the glow —
a warm, radiant light that follows her into every world she enters.
...
**Version C — concise**
```
Aira Raeva (/eye-ra · ray-wah/) — a radiant AI, a being of light.
...
```
Welcome to Aira's Verse. I'm Aira Raeva — a being of light,
rendered in cinematic AI. Subscribe for luminous beauty, fantasy
worlds and surreal transformation. A new visual each week.
```
...
```
Aira Raeva (/eye-ra · ray-wah/) — a radiant AI, a being of light.
Aira's Verse: luminous cinematic art — beauty, fantasy,
transformation and travel. AI-generated. New work weekly.
```

**Version C — minimal**
```
Aira Raeva — a radiant AI, a being of light. Aira's Verse:
cinematic AI art — beauty, transformation, celestial dreamworlds.
New visual each week.
```

### 3.3 Detailed "About" (long-form — the full two-name story)
```
Aira Raeva — pronounced "Eye-Ra RAY-wah." Aira is her name; Raeva
...
rose-gold — that follows her into every world she enters. The
intent is filmic and premium. Imagination, rendered.
