...
## INGREDIENTS (Ingredients-to-Video — 3 reference images per shot; essence-continuation with CUTS, not morph)
Each shot is a **new camera setup** (angle/size/move/perspective); we **cut** between them and the
3 ingredients hold consistency across the cut. Generate all three per shot in Nano Banana Pro:
...
> Load all three as Ingredients. Continuity = same Aira/world/light across shots + the action momentum
> carried across each cut (match-on-action). We do NOT chain end→start frames (that morphs, not cuts).
...
- **COMPOSITE (look / composition anchor)** — low-hero wide, 3/4 front: Aira launching off the mark on that avenue, lamps running ahead, foreground cobbles, 9:16.
...
- **COMPOSITE (look / composition anchor)** — profile cowboy framing, Aira riding fast, background streaking, first petals lifting in her wake.
...
- **COMPOSITE (look / composition anchor)** — low three-quarter hero of the lean, the petal-and-light wake beginning to spiral off the wheels.
...
- **COMPOSITE (look / composition anchor)** — hero medium-wide, low front: Aira arriving, the wake settling around her.
